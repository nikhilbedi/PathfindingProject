...
class SearchAgent(Agent):
  ...
  def __init__(self, fn='depthFirstSearch', prob='PositionSearchProblem', layout='testMaze', heuristic='nullHeuristic'):
    ...
    self.searchFunction = lambda x: func(x, layout=layout)
